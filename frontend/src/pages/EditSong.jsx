...
const EditSong = () => {
  ...
  useEffect(() => {
    const fetchSong = async () => {
      ...
      if (response.ok) {
        ...
        alert(data.error || 'Error al cargar la canción');
        navigate('/songs');
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    if (response.ok) {
      ...
      alert(data.error || 'Error al actualizar canción');
    }
  };
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center">
      ...
      >
        <h2 className="text-2xl font-bold text-white mb-6 text-center">Editar Canción</h2>
